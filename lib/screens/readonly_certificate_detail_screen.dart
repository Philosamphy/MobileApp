...
class ReadOnlyCertificateDetailScreen extends StatelessWidget {
  final DocumentModel certificate;

  const ReadOnlyCertificateDetailScreen({super.key, required this.certificate});
  ...
  Widget build(BuildContext context) {
    ...
    print(
      'ReadOnlyCertificateDetailScreen loaded for certificate: ${certificate.title}',
    );
              ...
              children: [
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.SizedBox(height: 20),
                    pw.Text('Issued by: ${certificate.issuerName}'),
